...
const PrivateProfile = ({ user }: { user: UserProfile }) => {
  ...
  return (
    <div className='flex h-fit w-full flex-col items-center gap-4 md:w-fit lg:sticky lg:-top-14 lg:pt-16'>
      <div className='relative flex w-full  flex-col gap-2 rounded-xl border-2 border-stroke bg-primary p-2 text-justify md:w-fit'>
